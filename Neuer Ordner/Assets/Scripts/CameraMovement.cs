...
public class CameraMovement : MonoBehaviour {
	...
	void Update()
	{
		...
		if (cameraPositionX >= 15 && cameraPositionX <= 45 && cameraPositionY <= 20 && cameraPositionY >= 14.5f) {
			...
			if(cameraPositionX >= 45f){
				this.gameObject.transform.position = new Vector3 (45f, this.transform.position.y, this.transform.position.z);
			}
